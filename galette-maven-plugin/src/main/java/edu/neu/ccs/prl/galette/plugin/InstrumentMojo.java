package edu.neu.ccs.prl.galette.plugin;

import edu.neu.ccs.prl.galette.instrument.*;
...
public class InstrumentMojo extends AbstractMojo {
     ...
     */
    @Parameter(property = "galette.javaHome")
     ...
     */
    @Parameter(property = "galette.outputDirectory", defaultValue = "${project.build.directory}/galette/java/")
     ...
     */
    @Parameter(property = "galette.linkedCaches")
     ...
     */
    @Parameter(property = "galette.forceCreation", readonly = true, defaultValue = "false")
    private boolean forceCreation;
    /**
     * Options passed to {@link Instrumentation#configure}.
     */
    @Parameter(property = "galette.options")
     ...
     */
    @Parameter(property = "galette.modules", defaultValue = "ALL-MODULE-PATH")
    private String modules;
    /**
     * True is information about instrumentation progress should be logged.
     */
    @Parameter(property = "galette.verbose", defaultValue = "false")
    ...
    private void instrument(Instrumentation instance, byte[] checksum, String info, MatchInfo match)
        ...
        try {
            long elapsedTime = GaletteInstrumenter.instrument(javaHome, outputDirectory, instance, verbose, modules);
    ...
    private static final class MatchInfo {
        ...
        public MatchInfo(File directory) {
            File parent = new File(directory, "galette-instrument-match");

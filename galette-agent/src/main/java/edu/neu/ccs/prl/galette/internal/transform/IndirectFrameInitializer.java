...
/**
 * Initializes the tag frame of methods that were not directly passed one as an argument.
 */
class IndirectFrameInitializer extends FrameInitializer {
    ...
    IndirectFrameInitializer(
            MethodVisitor mv, boolean isInstanceInitializer, int frameIndex, int totalBlocks, String descriptor) {
        super(mv, frameIndex);
